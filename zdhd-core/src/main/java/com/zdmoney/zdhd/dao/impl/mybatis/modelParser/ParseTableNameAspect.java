...
import com.zdmoney.zdhd.dao.impl.mybatis.interceptor.RowBoundsInterceptor;
import com.zdmoney.zdhd.dao.impl.mybatis.interceptor.SortListInterceptor;
...
public class ParseTableNameAspect {
    ...
    @Around("execution(* com.zdmoney.zdhd.dao.EntityDAO.*(..))")
